export const PROGRAM_LIST = [
    ...
    {name: "Applied Mathematics and Statistics", hasMajor: true, hasMinor: true},
    ...
    {name: "Biomedical Engineering", hasMajor: true, hasMinor: false},
    {name: "Biophysics", hasMajor: true, hasMinor: false},
    {name: "Business", hasMajor: false, hasMinor: true},
    {name: "Chemical and Biomolecular Engineering", hasMajor: true, hasMinor: false},
    {name: "Chemistry", hasMajor: true, hasMinor: false},
    {name: "Civic Life", hasMajor: false, hasMinor: true},
    {name: "Civil Engineering", hasMajor: true, hasMinor: true},
    ...
    {name: "Computer Engineering", hasMajor: true, hasMinor: false},
    {name: "Computer Integrated Surgery", hasMajor: false, hasMinor: true},
    {name: "Computer Science", hasMajor: true, hasMinor: true},
    ...
    {name: "General Engineering", hasMajor: true, hasMinor: false},
    ...
    {name: "Materials Science and Engineering", hasMajor: true, hasMinor: false},
    {name: "Mathematics", hasMajor: true, hasMinor: true},
    {name: "Mechanical Engineering", hasMajor: true, hasMinor: false},
    ...
    {name: "Systems Engineering", hasMajor: true, hasMinor: true},
